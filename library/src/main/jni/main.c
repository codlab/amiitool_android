...
JNIEXPORT jint Java_eu_codlab_amiitool_AmiiTool_setKeysUnfixed(JNIEnv *env, jobject this,
                                                               jbyteArray keydata,
                                                               jint dataLength) {
...
JNIEXPORT jint Java_eu_codlab_amiitool_AmiiTool_setKeysFixed(JNIEnv *env, jobject this,
                                                             jbyteArray keydata, jint dataLength) {
...
JNIEXPORT jint Java_eu_codlab_amiitool_AmiiTool_unpack(JNIEnv *env, jobject this, jbyteArray tag,
                                                       jint dataLength, jbyteArray returnData,
                                                       jint returnDataLength) {

    if (dataLength < NFC3D_AMIIBO_SIZE || returnDataLength < NFC3D_AMIIBO_SIZE ||
        dataLength != returnDataLength)
        return 0;
...
JNIEXPORT jint Java_eu_codlab_amiitool_AmiiTool_pack(JNIEnv *env, jobject this, jbyteArray tag,
                                                     jint dataLength, jbyteArray returnData,
                                                     jint returnDataLength) {
    ...
    jbyte *bufferPtr = (*env)->GetByteArrayElements(env, returnData, NULL);
    memcpy(bufferPtr, original, dataLength);
    memcpy(bufferPtr, modified, NFC3D_AMIIBO_SIZE);
    (*env)->ReleaseByteArrayElements(env, returnData, bufferPtr, 0);
